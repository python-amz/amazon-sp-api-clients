...
class Feeds20210630Client(BaseClient):
    def create_feed(
        ...
        **Usage Plan:**
        ...
        url = "/feeds/2021-06-30/feeds".format(**path_parameters)
    ...
    def get_feed(
        ...
        **Usage Plan:**
        ...
        url = "/feeds/2021-06-30/feeds/{feedId}".format(**path_parameters)
    ...
    def create_feed_document(
        ...
        **Usage Plan:**
        ...
        url = "/feeds/2021-06-30/documents".format(**path_parameters)
    ...
    def get_feed_document(
        ...
        **Usage Plan:**
        ...
        url = "/feeds/2021-06-30/documents/{feedDocumentId}".format(**path_parameters)
