...
class Error:
    ...
    code: str
    # {'generator': <__mp_main__.Generator object at 0x000002409D977310>, 'type': 'string'}
    details: str
    # {'generator': <__mp_main__.Generator object at 0x000002409D977310>, 'type': 'string'}
    message: str
    # {'generator': <__mp_main__.Generator object at 0x000002409D977310>, 'type': 'string'}
...
class GetItemEligibilityPreviewResponse:
    ...
    # {'ref': '#/components/schemas/ErrorList', 'generator': <__mp_main__.Generator object at 0x000002409D977310>}
    payload: dict[str, Any]
    # {'ref': '#/components/schemas/ItemEligibilityPreview', 'generator': <__mp_main__.Generator object at 0x000002409D977310>}
    pass
